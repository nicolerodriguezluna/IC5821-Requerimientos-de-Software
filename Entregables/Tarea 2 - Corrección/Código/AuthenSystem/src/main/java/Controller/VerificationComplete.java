 ...
 * @author Nott
 */
public class VerificationComplete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Ha demostrado que es un ser");

        jLabel8.setText("humano. Siga con su acción.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerificationComplete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VerificationComplete().setVisible(true);
            }
        });
    }
